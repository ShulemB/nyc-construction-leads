...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PermitLeads — NYC construction leads from DOB permit data" },
      { name: "description", content: "Search 500,000+ NYC DOB permit filings. Filter by trade, borough, budget. Find your next construction client before competitors do." },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Geist:wght@400;500;600&family=Geist+Mono&display=swap" },
    ],
  }),
